...
class OptionsPage extends React.Component {
  ...
  renderOptionForm() {
    return <OptionForm socketpush={this.state.socketpush} pollingId={this.state.pollingId} basicInfo={this.state.basicInfo} options ={this.state.options} setOptions={this.setOptions} history={this.props.history} location={this.props.location} userId={this.state.userId} />;
  }
  ...
  render() {
    ...
    return (
        <div style={{position:"relative"}}>
            ...
            <div class="bottom">
            <button onClick={this.state.socketpush
              // () => {
