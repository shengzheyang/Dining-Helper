...
const getTotalDistance = require('../controller/resultAnalyser.js');
...
const test = async () => {
  ...
  var distance = await getTotalDistance(['Panda Express, 15333 Culver Dr #400, Irvine, CA 92604, USA', 
  'Burger King, 2122 South East, Bristol St, Newport Beach, CA 92660, USA'], 
